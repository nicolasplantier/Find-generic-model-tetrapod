...
def run():
    ...
    print("Now that we have access to different instances of tetrapods, we need to identify the axes.")
    print("This algorithm find a 3D probability map : high probabilities meaning that a point has a high probability to belong to one of the axes of a tetrapod.")
    print(f"Estimate time : {int(9.26*len(list_tetrapods_files)//60)} minutes and {int(9.26*len(list_tetrapods_files)%60)} seconds")
