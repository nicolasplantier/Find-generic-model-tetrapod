...
if __name__ == "__main__": 
    ...
    print("This algorithm find the axes of the tetrapods using the points detected before")
    print(f"Estimate time : {int((0.5*len(list_filename_points))//60)} minutes and {int(((0.5*len(list_filename_points)))%60)} seconds")
